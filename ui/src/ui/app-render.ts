...
const lazyRuntime = createLazy(() => import("./views/runtime.ts"));
  ...
  return html`
    ...
    >
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${
          state.tab === "runtime"
            ? lazyRender(lazyRuntime, (m) =>
                m.renderRuntime({
                  loading: state.runtimeLoading,
                  error: state.runtimeError,
                  snapshot: state.runtimeSnapshot,
                  consoleStore: state.runtimeConsoleStore,
                  importPreview: state.runtimeImportPreview,
                  importBusy: state.runtimeImportBusy,
                  importApplyResult: state.runtimeImportApplyResult,
                  federationLoading: state.federationLoading,
                  federationError: state.federationError,
                  federationStatus: state.federationStatus,
                  federationPreviewError: state.federationPreviewError,
                  federationPreview: state.federationPreview,
                  onRefresh: () => state.loadRuntime(),
                  onImportApply: () => state.applyRuntimeLegacyImport(),
                  onFederationPreview: () => state.previewRuntimeFederationRemote(),
                  onFederationSync: () => state.syncRuntimeFederationRemote(),
                  onFederationRemoteMaintenanceConfigure: (input) =>
                    state.configureRuntimeFederationRemoteMaintenance(input),
                  onFederationPushPolicyConfigure: (input) =>
                    state.configureRuntimeFederationPushPolicy(input),
                  onFederationMaintenanceConfigure: (input) =>
                    state.configureRuntimeFederationInboxMaintenance(input),
                  onFederationMaintenanceReview: () =>
                    state.reviewRuntimeFederationInboxMaintenance(),
                  onFederationPackageTransition: (input) =>
                    state.transitionRuntimeFederationPackage(input),
                  onCoordinatorSuggestionMaterialize: (id) =>
                    state.materializeRuntimeCoordinatorSuggestion({ id }),
                  onFederationAssignmentTransition: (input) =>
                    state.transitionRuntimeFederationAssignment(input),
                  onFederationAssignmentMaterialize: (id) =>
                    state.materializeRuntimeFederationAssignment({ id }),
                  onUserModelSave: (input) => state.saveRuntimeUserModel(input),
                  onUserModelMirrorSync: (force) => state.syncRuntimeUserModelMirror(force),
                  onUserModelMirrorImport: () => state.importRuntimeUserModelMirror(),
                  onSessionPreferenceSave: (input) => state.saveRuntimeSessionPreference(input),
                  onSessionPreferenceDelete: (id) => state.removeRuntimeSessionPreference(id),
                  onAgentSave: (input) => state.saveRuntimeAgent(input),
                  onAgentDelete: (id) => state.removeRuntimeAgent(id),
                  onSurfaceSave: (input) => state.saveRuntimeSurface(input),
                  onSurfaceRoleSave: (input) => state.saveRuntimeSurfaceRole(input),
                  onUserConsoleMaintenanceConfigure: (input) =>
                    state.configureRuntimeUserConsoleMaintenance(input),
                  onUserConsoleMaintenanceReview: () => state.reviewRuntimeUserConsoleMaintenance(),
                  onUserModelOptimizationReview: () => state.reviewRuntimeUserModelOptimization(),
                  onUserModelOptimizationAdopt: (id) => state.adoptRuntimeUserModelOptimization(id),
                  onUserModelOptimizationReject: (input) =>
                    state.rejectRuntimeUserModelOptimization(input),
                  onRoleOptimizationReview: () => state.reviewRuntimeRoleOptimization(),
                  onRoleOptimizationAdopt: (id) => state.adoptRuntimeRoleOptimization(id),
                  onRoleOptimizationReject: (input) => state.rejectRuntimeRoleOptimization(input),
                  onCapabilitiesSync: () => state.syncRuntimeCapabilities(),
                  onCapabilityEntrySet: (input) => state.setRuntimeCapabilityRegistryEntry(input),
                  onCapabilityMcpGrantSet: (input) => state.setRuntimeCapabilityMcpGrant(input),
                  onIntelConfigure: (input) => state.configureRuntimeIntel(input),
                  onIntelRefresh: (domains) => state.refreshRuntimeIntel(domains),
                  onIntelDispatch: () => state.dispatchRuntimeIntelDeliveries(),
                  onIntelSourceSave: (input) => state.saveRuntimeIntelSource(input),
                  onIntelSourceDelete: (id) => state.removeRuntimeIntelSource(id),
                  onIntelPin: (input) => state.pinRuntimeIntel(input),
                  onMemoryReview: () => state.reviewRuntimeMemory(),
                  onMemoryConfigure: (input) => state.configureRuntimeMemory(input),
                  onMemoryReinforce: (input) => state.reinforceRuntimeMemory(input),
                  onMemoryInvalidate: (input) => state.invalidateRuntimeMemory(input),
                  onMemoryRollback: (input) => state.rollbackRuntimeMemoryInvalidation(input),
                  onEvolutionConfigure: (input) => state.configureRuntimeEvolution(input),
                  onEvolutionReview: () => state.runRuntimeEvolutionReview(),
                  onEvolutionVerificationAcknowledge: (input) =>
                    state.acknowledgeRuntimeEvolutionVerification(input),
                  onEvolutionCandidateStateSet: (input) =>
                    state.setRuntimeEvolutionCandidateState(input),
                  onTaskLoopConfigure: (input) => state.configureRuntimeTaskLoop(input),
                  onTaskSave: (input) => state.saveRuntimeTask(input),
                  onTaskLoopTick: () => state.tickRuntimeTaskLoop(),
                  onTaskPlan: (taskId) => state.planRuntimeTask(taskId),
                  onWaitingUserTaskRespond: (input) => state.respondRuntimeWaitingUserTask(input),
                }),
              )
            : nothing
        }
