...
const marker = '<script src="/plugins/openclaw-codex-control/inject.js" data-openclaw-codex-control></script>';
...
function ensurePluginEnabled() {
  ...
  config.plugins.entries[pluginId] = {
    ...(config.plugins.entries[pluginId] && typeof config.plugins.entries[pluginId] === "object" ? config.plugins.entries[pluginId] : {}),
    enabled: true
  };
