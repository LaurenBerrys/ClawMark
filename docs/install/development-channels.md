...
ClawMark ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ClawMark also aligns
the install method:
...
When you switch channels with `openclaw update`, ClawMark also syncs plugin sources:
