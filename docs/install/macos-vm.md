---
summary: "Run ClawMark in a sandboxed macOS VM (local or hosted) when you need isolation or iMessage"
read_when:
  - You want ClawMark isolated from your main macOS environment
...
# ClawMark on macOS VMs (Sandboxing)
...
Run ClawMark in a sandboxed macOS VM on your existing Apple Silicon Mac using [Lume](https://cua.ai/docs/lume).
...
5. SSH in, install ClawMark, configure channels
6. Done
...
The VM runs in the background. ClawMark's daemon keeps the gateway running.
...
This is the killer feature of running on macOS. Use [BlueBubbles](https://bluebubbles.app) to add iMessage to ClawMark.
