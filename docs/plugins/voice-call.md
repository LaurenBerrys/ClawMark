...
read_when:
  - You want to place an outbound voice call from ClawMark
...
Voice calls for ClawMark via a plugin. Supports outbound notifications and
...
```bash
openclaw voicecall call --to "+15555550123" --message "Hello from ClawMark"
