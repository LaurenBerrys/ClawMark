...
read_when:
  - You want to publish a third-party ClawMark plugin
...
This page tracks high-quality **community-maintained plugins** for ClawMark.
...
- **WeChat** — Connect ClawMark to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
