---
summary: "First-run onboarding flow for ClawMark on macOS"
read_when:
...
- By default, ClawMark is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give ClawMark">
