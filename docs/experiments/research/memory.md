...
read_when:
  ...
  - Deciding: standalone CLI vs deep ClawMark integration
...
Recommendation: **deep integration in ClawMark**, but keep a separable core library.

### Why integrate into ClawMark?

- ClawMark already knows:
