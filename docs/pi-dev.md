...
This guide summarizes a sane workflow for working on the pi integration in ClawMark.
...
State lives under the ClawMark state directory. Default is `~/.openclaw`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
