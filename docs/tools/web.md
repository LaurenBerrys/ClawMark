...
ClawMark ships two lightweight web tools:
...
- In auto-detect mode, ClawMark resolves only the selected provider key. Non-selected provider SecretRefs stay inactive until selected.
