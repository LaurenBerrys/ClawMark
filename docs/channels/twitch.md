...
read_when:
  - Setting up Twitch chat integration for ClawMark
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. ClawMark connects as a Twitch user (bot account) to receive and send messages in channels.
