...
ClawMark treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams, Zalo.

## Beginner intro (2 minutes)

ClawMark “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, ClawMark can see that group and respond there.
...
Translation: allowlisted senders can trigger ClawMark by mentioning it.
