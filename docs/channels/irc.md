---
title: IRC
description: Connect ClawMark to IRC channels and direct messages.
summary: "IRC plugin setup, access controls, and troubleshooting"
read_when:
  - You want to connect ClawMark to IRC channels or DMs
  - You are configuring IRC allowlists, group policy, or mention gating
---

Use IRC when you want ClawMark in classic channels (`#room`) and direct messages.
...
Even if a channel is allowed (via `groupPolicy` + `groups`) and the sender is allowed, ClawMark defaults to **mention-gating** in group contexts.
