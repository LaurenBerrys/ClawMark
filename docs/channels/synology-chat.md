---
summary: "Synology Chat webhook setup and ClawMark config"
read_when:
  - Setting up Synology Chat with ClawMark
...
3. Point the outgoing webhook URL to your ClawMark gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in ClawMark.
...
```bash
openclaw message send --channel synology-chat --target 123456 --text "Hello from ClawMark"
