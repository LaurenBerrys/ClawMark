...
The current macOS app bundle (`OpenClaw.app`) no longer bundles Node/Bun or the Gateway runtime. The macOS app
...
- “OpenClaw Active” (current UI label) enables/disables the LaunchAgent.
