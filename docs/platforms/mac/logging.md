---
summary: "ClawMark macOS logging: rolling diagnostics file log + unified log privacy flags"
read_when:
...
ClawMark routes macOS app logs through swift-log (unified logging by default) and can write a local, rotating file log to disk when you need a durable capture.
...
## Enable for ClawMark (`ai.openclaw`)
