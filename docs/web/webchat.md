...
1. Start the gateway.
2. Open the WebChat UI (macOS/iOS app) or the User Console chat tab.
...
## User Console agents tools panel

- The User Console `/agents` Tools panel fetches a runtime catalog via `tools.catalog` and labels each
