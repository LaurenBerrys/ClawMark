# Contributing to the ClawMark Threat Model

Thanks for helping make ClawMark more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of ClawMark are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [ClawMark Threat Model](/security/THREAT-MODEL-ATLAS)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the ClawMark security hall of fame for significant contributions.
