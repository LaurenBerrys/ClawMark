...
summary: Machine-checked security models for ClawMark’s highest-risk paths.
read_when:
...
This page tracks ClawMark’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that ClawMark enforces its
...
**What this is not (yet):** a proof that “ClawMark is secure in all respects” or that the full TypeScript implementation is correct.
