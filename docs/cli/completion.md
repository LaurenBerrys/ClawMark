...
read_when:
  ...
  - You need to cache completion scripts under ClawMark state
title: "completion"
---
...
- `--install` writes a small "ClawMark Completion" block into your shell profile and points it at the cached script.
