---
summary: "Use Qwen OAuth (free tier) in ClawMark"
read_when:
  - You want to use Qwen with ClawMark
...
If you already logged in with the Qwen Code CLI, ClawMark will sync credentials
