---
summary: "Use Qianfan's unified API to access many models in ClawMark"
read_when:
...
3. ClawMark installed on your system
...
4. Copy the API key for use with ClawMark
...
- [ClawMark Configuration](/gateway/configuration)
