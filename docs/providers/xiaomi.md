---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ClawMark"
read_when:
  - You want Xiaomi MiMo models in ClawMark
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ClawMark uses
