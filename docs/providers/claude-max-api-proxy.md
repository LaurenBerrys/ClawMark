...
You can point ClawMark at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ClawMark
...
- [Anthropic provider](/providers/anthropic) - Native ClawMark integration with Claude setup-token or API keys
