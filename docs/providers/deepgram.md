...
Deepgram is a speech-to-text API. In ClawMark it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, ClawMark uploads the audio file to Deepgram and injects the transcript
