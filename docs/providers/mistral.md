---
summary: "Use Mistral models and Voxtral transcription with ClawMark"
read_when:
  - You want to use Mistral models in ClawMark
...
ClawMark supports Mistral for both text/image model routing (`mistral/...`) and
