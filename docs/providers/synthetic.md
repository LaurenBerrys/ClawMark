---
summary: "Use Synthetic's Anthropic-compatible API in ClawMark"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ClawMark registers it as the
...
Note: ClawMark's Anthropic client appends `/v1` to the base URL, so use
