...
This document outlines the design for integrating "Kilo Gateway" as a first-class provider in ClawMark, modeled after the existing OpenRouter implementation. Kilo Gateway uses an OpenAI-compatible completions API with a different base URL.
