...
FEED_URL=${2:-"https://raw.githubusercontent.com/LaurenBerrys/ClawMark/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/LaurenBerrys/ClawMark/releases/download/v${VERSION}/"}
